...
public class DatabaseConnection {
    ...
    public void connectToDb() throws SQLException {
        final Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/company_db", "nm", "password");
    ...
    public void queryParameters() throws SQLException {
        ...
        final Statement stmt = conn.createStatement();
        final ResultSet rs = stmt.executeQuery("select count(*) from office_locations where location_name in ('London', 'New York', 'Paris')");
        assertTrue(rs.next());
